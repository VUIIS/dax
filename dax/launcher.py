...
cluster queue"
    ...
    def build_project(self, intf, project_id, lockfile_prefix, sessions_local,
        ...
        has_new = self.has_new_processors(intf, project_id, exp_procs,
                                          scan_procs)
 ...
 last_mod=%s"
    ...
    def build_session(self, intf, sess_info, sess_proc_list,
    ...
    # TODO: BenM/assessor_of_assessor/the list of candidate assessors is
    ...
    # lose the rechecking
    # TODO: BenM/assessor_of_assessor/review use of has_inputs call
        ...
        for scan_proc in scan_proc_list:
            ...
            if self.launcher_type in ['diskq-xnat', 'diskq-combined']:
                for inputs, p_assr in mapping[1]:
                    ...
                    # TODO: BenM/assessor_of_assessor/session doesn't have
                    # NEED_TO_RUN; why not? Seems consolidation is in order
                    if p_assr.info()['procstatus'] in [task.NEED_INPUTS,
                                                       task.NEED_TO_RUN] or \
                       p_assr.info()['qcstatus'] in [task.RERUN, task.REPROC]:
