...
REDCAP_VAR = {'project':'dax_project',
              ...
              'build_start_date':'dax_build_start_date',
              'build_end_date':'dax_build_end_date',
              'build_pid':'dax_build_pid',
              'update_start_date':'dax_update_start_date',
              'update_end_date':'dax_update_end_date',
