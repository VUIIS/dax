...
public abstract class AutoFsLongfsdataHemisphereRegion extends org.nrg.xdat.base.BaseElement implements org.nrg.xdat.model.FsLongfsdataHemisphereRegionI {
	public static final Logger logger = Logger.getLogger(AutoFsLongfsdataHemisphereRegion.class);
	public static final String SCHEMA_ELEMENT_NAME="fs:longFSData_hemisphere_region";

	public AutoFsLongfsdataHemisphereRegion(ItemI item)
	{
		super(item);
	}

	public AutoFsLongfsdataHemisphereRegion(UserI user)
	{
		super(user);
	}

	/*
	 * @deprecated Use AutoFsLongfsdataHemisphereRegion(UserI user)
	 **/
	public AutoFsLongfsdataHemisphereRegion(){}

	public AutoFsLongfsdataHemisphereRegion(Hashtable properties,UserI user)
	{
	...
	public Integer getFsLongfsdataSurfRegionId() {
		try{
			if (_FsLongfsdataSurfRegionId==null){
				_FsLongfsdataSurfRegionId=getIntegerProperty("fs_longFSData_surf_region_id");
	...
	public void setFsLongfsdataSurfRegionId(Integer v){
		try{
		setProperty(SCHEMA_ELEMENT_NAME + "/fs_longFSData_surf_region_id",v);
		_FsLongfsdataSurfRegionId=null;
		} catch (Exception e1) {logger.error(e1);}
	}

	public static ArrayList<org.nrg.xdat.om.FsLongfsdataHemisphereRegion> getAllFsLongfsdataHemisphereRegions(org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.FsLongfsdataHemisphereRegion> al = new ArrayList<org.nrg.xdat.om.FsLongfsdataHemisphereRegion>();
	...
	public static ArrayList<org.nrg.xdat.om.FsLongfsdataHemisphereRegion> getFsLongfsdataHemisphereRegionsByField(String xmlPath, Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.FsLongfsdataHemisphereRegion> al = new ArrayList<org.nrg.xdat.om.FsLongfsdataHemisphereRegion>();
		try {
	...
	public static ArrayList<org.nrg.xdat.om.FsLongfsdataHemisphereRegion> getFsLongfsdataHemisphereRegionsByField(org.nrg.xft.search.CriteriaCollection criteria, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.FsLongfsdataHemisphereRegion> al = new ArrayList<org.nrg.xdat.om.FsLongfsdataHemisphereRegion>();
		try {
	...
	public static FsLongfsdataHemisphereRegion getFsLongfsdataHemisphereRegionsByFsLongfsdataSurfRegionId(Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		try {
			org.nrg.xft.collections.ItemCollection items = org.nrg.xft.search.ItemSearch.GetItems("fs:longFSData_hemisphere_region/fs_longFSData_surf_region_id",value,user,preLoad);
			ItemI match = items.getFirst();
			if (match!=null)
				return (FsLongfsdataHemisphereRegion) org.nrg.xdat.base.BaseElement.GetGeneratedItem(match);
			else
				 return null;
		} catch (Exception e) {
			logger.error("",e);
