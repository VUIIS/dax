...
public abstract class AutoFsFsdataRegion extends org.nrg.xdat.base.BaseElement implements org.nrg.xdat.model.FsFsdataRegionI {
	public static final Logger logger = Logger.getLogger(AutoFsFsdataRegion.class);
	public static final String SCHEMA_ELEMENT_NAME="fs:fsData_region";

	public AutoFsFsdataRegion(ItemI item)
	{
		super(item);
	}

	public AutoFsFsdataRegion(UserI user)
	{
		super(user);
	}

	/*
	 * @deprecated Use AutoFsFsdataRegion(UserI user)
	 **/
	public AutoFsFsdataRegion(){}

	public AutoFsFsdataRegion(Hashtable properties,UserI user)
	{
	...
	public Integer getFsFsdataVolRegionId() {
		try{
			if (_FsFsdataVolRegionId==null){
				_FsFsdataVolRegionId=getIntegerProperty("fs_fsData_vol_region_id");
	...
	public void setFsFsdataVolRegionId(Integer v){
		try{
		setProperty(SCHEMA_ELEMENT_NAME + "/fs_fsData_vol_region_id",v);
		_FsFsdataVolRegionId=null;
		} catch (Exception e1) {logger.error(e1);}
	}

	public static ArrayList<org.nrg.xdat.om.FsFsdataRegion> getAllFsFsdataRegions(org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.FsFsdataRegion> al = new ArrayList<org.nrg.xdat.om.FsFsdataRegion>();
	...
	public static ArrayList<org.nrg.xdat.om.FsFsdataRegion> getFsFsdataRegionsByField(String xmlPath, Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.FsFsdataRegion> al = new ArrayList<org.nrg.xdat.om.FsFsdataRegion>();
		try {
	...
	public static ArrayList<org.nrg.xdat.om.FsFsdataRegion> getFsFsdataRegionsByField(org.nrg.xft.search.CriteriaCollection criteria, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.FsFsdataRegion> al = new ArrayList<org.nrg.xdat.om.FsFsdataRegion>();
		try {
	...
	public static FsFsdataRegion getFsFsdataRegionsByFsFsdataVolRegionId(Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		try {
			org.nrg.xft.collections.ItemCollection items = org.nrg.xft.search.ItemSearch.GetItems("fs:fsData_region/fs_fsData_vol_region_id",value,user,preLoad);
			ItemI match = items.getFirst();
			if (match!=null)
				return (FsFsdataRegion) org.nrg.xdat.base.BaseElement.GetGeneratedItem(match);
			else
				 return null;
		} catch (Exception e) {
			logger.error("",e);
