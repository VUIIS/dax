...
public class FsFsdataHemisphereRegionBean extends BaseElement implements java.io.Serializable, org.nrg.xdat.model.FsFsdataHemisphereRegionI {
	public static final Logger logger = Logger.getLogger(FsFsdataHemisphereRegionBean.class);
	public static final String SCHEMA_ELEMENT_NAME="fs:fsData_hemisphere_region";

	public String getSchemaElementName(){
		return "fsData_hemisphere_region";
	}
