...
public class FsLongfsdataRegionBean extends BaseElement implements java.io.Serializable, org.nrg.xdat.model.FsLongfsdataRegionI {
	public static final Logger logger = Logger.getLogger(FsLongfsdataRegionBean.class);
